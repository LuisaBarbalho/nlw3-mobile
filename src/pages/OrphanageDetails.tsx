...
export default function OrphanageDetails() {
  ...
  function handleOpenWhatsappContact() {
    Linking.openURL(`https://wa.me/55${orphanage?.whatsapp_number}`)
  }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <Text style={styles.description}>{orphanage.whatsapp_number}</Text>
        ...
        <RectButton onPress={handleOpenWhatsappContact} style={styles.contactButton}>
